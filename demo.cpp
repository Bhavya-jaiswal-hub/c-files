...
//    }
      // <--return concept -->
             int maxx(int num1,int num2) {
               ...
               //  if we give the num1 is smaller than  the num2 
               //  than what return value it will give 
               //    whether it will give the garbage value or does not 
               //    return anything 
               //    the answer is it will return the garbage value
               //   <--return concept completer -->
             }
...
//           }
   ...
   //       cout << s ;
      ...
      // write a function which gives the sum of the two numbers
         ...
         //  cout << minimum;
         //  int maximum = max(num1,num2) ;  this maximum is the inbuild max function used for finding the maximum of the given two numbers
